-- Migration 017: Add authorization check to delete_user_data RPC
-- Ensures users can only delete their own account data
...
DECLARE
    ...
    v_member_count INT;
BEGIN
    -- Authorization: caller must be the user being deleted
